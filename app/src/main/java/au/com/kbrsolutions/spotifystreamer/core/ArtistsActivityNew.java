...
public class ArtistsActivityNew extends ActionBarActivity {
    ...
    private final static String LOG_TAG = ArtistsActivityNew.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_artists_new);
